...
DATABASES = {
    'default': {
        ...
        'HOST': env('HOST'),#os.environ.get('HOST'),
        'PORT': env('PORT'),#os.environ.get('PORT'),
        'USER': env('USER'),#os.environ.get('USER'),
        'PASSWORD': env('PASSWORD'),#os.environ.get('PASSWORD'),
        'NAME': env('NAME'),#os.environ.get('NAME'),
        'OPTIONS':{
...
DJOSER = {
    ...
    'SOCIAL_AUTH_ALLOWED_REDIRECT_URIS': ['http://localhost:8000/google', 'http://localhost:8000/facebook'],#cambiar
    'SERIALIZERS': {
...
if not DEBUG:
    DEFAULT_FROM_EMAIL = 'Cucchi - Test de Mail <cucchi.sm11@gmail.com>'
